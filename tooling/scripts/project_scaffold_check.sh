...
check_file_contains "project Makefile exposes docker-redeploy target" "$target/Makefile" "docker-redeploy:"
check_file_contains "project Makefile sources project-owned Makefile.local" "$target/Makefile" "-include Makefile.local"
check_exists "project-owned Makefile.local seed" "$target/Makefile.local"
