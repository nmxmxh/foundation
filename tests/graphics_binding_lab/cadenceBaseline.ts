// Frozen before the completion wake optimization, 2026-09-22. Benchmark use only.
import type { RenderSurfaceCommand, RenderSurfaceEvent } from "@ovasabi/runtime-browser";
import { renderRequirementsFailure, type RenderSurfaceEvidence } from "@ovasabi/runtime-browser";
import { attachRenderStateReader, type RenderStateReader } from "@ovasabi/runtime-browser";
import type { RenderSurfaceQualityTier } from "@ovasabi/runtime-browser";
