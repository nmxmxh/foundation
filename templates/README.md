...
* **Platform Modules (`foundation/`)**: These contain core primitives (for example, `server-kit`, `runtime-transport`, `ui-minimal`). They are **read-only references** and should not be modified directly.
