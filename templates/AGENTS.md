...
**New here?** Start with [`README.md`](README.md) → [`docs/foundation/PHILOSOPHY.md`](docs/foundation/PHILOSOPHY.md) → [`docs/foundation/foundation_quick_start.md`](docs/foundation/foundation_quick_start.md), then come back to this file for the agent operating contract.
...
| Mesh dispatch (placement across nodes) | `docs/foundation/mesh_dispatch_practices.md` or `docs/mesh_dispatch_practices.md` |
